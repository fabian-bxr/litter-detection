...
- **Vision model: `gemma4:31b-cloud` on Ollama Cloud** (exact model name confirmed 2026-06-13); on Ollama Cloud use `PromptedOutput`/`ToolOutput`, never `NativeOutput` (unsupported there).
